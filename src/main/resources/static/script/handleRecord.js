    ...
    dialogOverlay.innerHTML = `
        <div class="confirmation-dialog">
            ...
            <div class="confirmation-dialog-buttons">
                <button class="recorder-btn text-only" id="confirm-cancel-btn">Cancel</button>
                <button class="recorder-btn confirmation-btn-confirm" id="confirm-confirm-btn">Confirm</button>
            </div>
        </div>
    `;
...
export function openAudioRecorder() {
    ...
    rerecordBtn.addEventListener('click', () => {
        showConfirmationDialog(
            'Are you sure? The current recording will be deleted.',
    ...
    overlay.innerHTML = `
        <div class="recorder-modal is-initial">
            ...
            <div class="recorder-footer">
                <span class="footer-text">Explain your idea.</span>
                <div class="footer-buttons">
                    <div class="initial-controls"><button id="start-btn" class="recorder-btn">Start recording</button></div>
                    <div class="recording-controls"><button id="stop-btn" class="recorder-btn">Stop recording</button></div>
                    <div class="review-controls">
                        <button id="rerecord-btn" class="recorder-btn text-only">Re-record</button>
                        <button id="add-btn" class="recorder-btn">Add to prompt</button>
                    </div>
                </div>
            </div>
        </div>
